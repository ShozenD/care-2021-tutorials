...
-   Vectors are one dimensional objects of length n, all one data type
-   Lists are an ordered lists of miscellaneous objects
-   Data Frames are rectangular arrays (rows and columns) of **mixed**
    data types (each column can be a different data type)
...
[!ggplot-layers]("./figures/ggplot-layered.png")

Recommended Reading: [A Layered Grammar of
Graphics](https://byrneslab.net/classes/biol607/readings/wickham_layered-grammar.pdf)
by Hadley Wickham
...
ggplot(iris, aes(x = Sepal.Length, y = Petal.Length, color = Species)) + 
  ...
  labs(
    x = "Sepal Length [cm]",
    y = "Petal Length [cm]",
    title = "Relationship between sepal and petal",
